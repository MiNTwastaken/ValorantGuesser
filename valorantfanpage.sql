...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2024 at 06:20 PM
...
INSERT INTO `user` (`username`, `password`, `email`, `picture`, `favorite`, `tries`, `admin`, `lvl`, `exp`, `current_table`, `winner`, `joined_at`) VALUES
('OGadmin', '$2y$10$LcchI22A9E5DPQeAJVayzOQFErncwOt.W.CoajNFyppSzggO2VVRe', 'TheAdminHimself@gmail.com', '/ValorantGuesser/img/profile/UnknownAgent.png', 'Classified', 0, 1, 999, 9999, 0, 0, '2024-05-01 10:42:34'),
('w', '$2y$10$3nJztnixN.oxmfk5DnhwoeuUCwvbuf8QjqjHVRImRDtCSmFYr5tBG', 'FortniteBaller@gmail.com', '/ValorantGuesser/img/profile/UnknownAgent.png\r\n', 'Classified', 0, 0, 9, 9100, 0, 0, '2024-05-03 12:13:56');
